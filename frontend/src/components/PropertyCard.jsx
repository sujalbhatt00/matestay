...
const PropertyCard = ({ property }) => {
  ...
  return (
    <Card className="group flex flex-col h-full overflow-hidden rounded-xl border border-border hover:shadow-lg transition-shadow duration-300">
      <div className="relative w-full aspect-[4/3] bg-muted flex-shrink-0">
        <img
          src={displayImage}
          alt={title}
          className="object-cover w-full h-full"
          style={{ aspectRatio: "4/3", minHeight: 0, minWidth: 0 }}
        />
